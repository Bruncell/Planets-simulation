#include <SFML/Graphics.hpp> //УПРАВЛЕНИЕ ПЛАНЕТАМИ - когда ты нажимаешь 1 2 или 3 ты виделяешь 1 2 или 3 планету и после того как ты ее выделил ты можешь на Q ее переместить к мышке или на левую кнопку мыши она станет притягиватся к мыше (ВСЕ НУЖНО ДЕЛАТЬ ЗАЖИМАЯ кнопку 1 2 или 3 )
#include <iostream>          //ЗАПУСКАТЬ СИМУЛЯЦИЮ НА ПРАВУЮ КНОПКУ МЫШИ
#include <cmath>
